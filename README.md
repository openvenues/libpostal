...
libpostal is a C library for parsing/normalizing street addresses around the world using statistical NLP and open data. For an overview of the research and thought process that went into building libpostal, check out the [introductory blog post](https://medium.com/@albarrentine/statistical-nlp-on-openstreetmap-b9d573e6cc86).
