...
libpostal_fuzzy_duplicate_status_t is_name_duplicate_fuzzy(libpostal_t *instance, size_t num_tokens1, char **tokens1, double *token_scores1, size_t num_tokens2, char **tokens2, double *token_scores2, libpostal_fuzzy_duplicate_options_t options);
libpostal_fuzzy_duplicate_status_t is_street_duplicate_fuzzy(libpostal_t *instance, size_t num_tokens1, char **tokens1, double *token_scores1, size_t num_tokens2, char **tokens2, double *token_scores2, libpostal_fuzzy_duplicate_options_t options);
