...
gazetteer_t gazetteer_config[] = {
    ...
    {DICTIONARY_SUPERBLOCK, LIBPOSTAL_ADDRESS_HOUSE_NUMBER},
    {DICTIONARY_BLOCK, LIBPOSTAL_ADDRESS_HOUSE_NUMBER},
    {DICTIONARY_LOT, LIBPOSTAL_ADDRESS_HOUSE_NUMBER | LIBPOSTAL_ADDRESS_UNIT},
