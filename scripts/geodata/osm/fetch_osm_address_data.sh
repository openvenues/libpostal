...
VALID_BUILDING_VENUE_KEYS="building=school or building=greenhouse or building=church or building=warehouse or building=cabin or building=farm or building=civic or building=university or building=public or building=hospital or building=hotel or building=chapel or building=kindergarten or building=ruins or building=dormitory or building=train_station or building=mosque or building=stable or building=college or building=bunker or building=shop or building=supermarket or building=temple or building=factory or building=temp or building=kiosk or building=chalet or building=store or building=ruin or building=grandstand or building=cathedral or building=pub or building=station or building=transportation or building=government_office or building=government or building=castle or building=shrine or building=bakehouse or building=synagogue or building=stadium or building=conservatory or building=pavilion or building=restaurant or building=museum or building=bell_tower or building=basilica or building=marketplace or building=greenhouse_horticulture or building=public_building or building=police or building=convent or building=mall or building=library or building=motel or building=fire_station or building=sports_centre or building=airport or building=brewery or building=data_center or building=railway_station or building=trailer_park or building=cinema or building=community_centre or building=cultural or building=bandstand or building=theatre or building=palace or building=club_house or building=sports_hall or building=riding_school or building=place_of_worship or building=gym or building=embassy or building=parish_hall or building=hostel or building=cafe or building=gymnasium"
...
VALID_LANDUSE_KEYS="landuse=basin or landuse=cemetery or landuse=greenhouse_horticulture or landuse=landfill or landuse=plant_nursery or landuse=port or landuse=quarry or landuse=recreation_ground or landuse=resevoir or landuse=village_green or landuse=vineyard"

VALID_VENUE_KEYS="( ( $VALID_AEROWAY_KEYS ) or ( $VALID_AMENITY_KEYS ) or ( $VALID_BUILDING_VENUE_KEYS ) or ( $VALID_HISTORIC_KEYS ) or ( $VALID_OFFICE_KEYS ) or ( $VALID_PLACE_KEYS ) or ( $VALID_SHOP_KEYS ) or ( $VALID_TOURISM_KEYS ) or ( $VALID_LEISURE_KEYS ) or ( $VALID_LANDUSE_KEYS ) )"
...
osmfilter $PLANET_O5M --keep="( name= and ( $VALID_VENUE_KEYS ) )" --drop="boundary= or building= or ( place= and not ( $VALID_SUBDIVISION_PLACE_KEYS ) )" --drop-author --drop-version -o=$PLANET_VENUE_BOUNDARIES_O5M &
...
osmfilter $PLANET_O5M --keep="( name=  and ( $VALID_VENUE_KEYS or ( $VALID_RAIL_STATION_KEYS and addr:street= and ( wikipedia= or wikipedia:*= ) ) ) )" --drop-author --drop-version -o=$PLANET_VENUES_O5M
...
osmfilter $PLANET_VENUES_LATLONS --keep="name= and ( ( $VALID_VENUE_KEYS or ( $VALID_RAIL_STATION_KEYS and addr:street= and ( wikipedia= or wikipedia:*= ) ) ) )" -o=$PLANET_VENUES
