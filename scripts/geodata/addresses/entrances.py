...
class Entrance(NumberedComponent):
    ...
    @classmethod
    def phrase(cls, entrance, language, country=None, num_type=None, direction=None, direction_probability=None):
        if entrance is None:
            return None

        key = 'entrances.alphanumeric'
        return cls.numeric_phrase(key, entrance, language,
